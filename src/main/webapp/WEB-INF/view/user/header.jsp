            ...
            <div class="navbar-tools">
                ...
                <ul class="nav navbar-right">
                                    ...
                                    <ul>
                                            ...
                                            <a href="javascript:;">
                                                <div class="clearfix">
                                                    <div class="thread-image">
                                                        <img alt="" src="<%=request.getContextPath() %>/adminResources/image/avatar-2.jpg">
                                                    </div>
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <div class="clearfix">
                                                    <div class="thread-image">
                                                        <img alt="" src="<%=request.getContextPath() %>/adminResources/image/avatar-5.jpg">
                                                    </div>
                                                    <div class="thread-content">
                    ...
                    <li class="dropdown current-user">
                        <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
                            <img src="<%=request.getContextPath() %>/adminResources/image/avatar-1-small.jpg" class="circle-img" alt="">
