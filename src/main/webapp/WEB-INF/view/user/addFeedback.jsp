                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <h2><i class="fa fa-pencil-square teal"></i> FEEDBACK</h2>
                               
                                <hr>
                                
                               <%@taglib prefix="sp" uri="http://www.springframework.org/tags/form"%>
                                <sp:form action="/user/insertFeedback" method="post" role="form" modelAttribute="feedbackofuser">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <sp:input placeholder="Insert Feedback" class="form-control" id="firstname" path="feedback"/>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input class="btn btn-yellow btn-block" type="submit" value="Add Feedback">
