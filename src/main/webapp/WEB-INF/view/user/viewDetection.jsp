...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/adminResources/css/skins/all.css" />
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/adminResources/css/perfect-scrollbar.min.css" />
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/adminResources/css/weetalert.css" />
    ...
    <link type="text/css" rel="stylesheet" id="star_feed" href="${pageContext.request.contextPath }/adminResources/css/star.css" />
    <!-- end: MAIN CSS -->
    <!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
    <link href="${pageContext.request.contextPath }/adminResources/css/summernote.css" rel="stylesheet" />
...
<script type="text/javascript">
	function fn1()
	{
		...
		path = fileId.value.replace("C:\\fakepath\\","D:\\OpenCV_3_License_Plate_Recognition_Python-master\\LicPlateImages\\")
		...
		for (var i = 1; i < dropdownId.options.length; i++) {
		 
			if (dropdownId.options[i].selected) {
			 	
			
		    	values.push(dropdownId.options[i].text);
	...
	htp.open("get","http://127.0.0.1:5000/?imageName="+path+"&offenceName="+values,true);
	htp.send();
}
...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-external-link-square"></i> View Detection
  ...
  <select id="dropdownId" class="mdb-select colorful-select dropdown-primary md-form" multiple searchable="Search here..">
    
  		  <option value="" disabled selected>Choose Offences</option>
  
	    <c:forEach items="${offenceList}" var="i">	
	    
	    	<option value="${i.offenceId}" label="${i.offenceName}">${i.offenceName}</option>
	    </c:forEach>
  </select>
		...
		<input type="button" value="Detection" onclick="fn1()" style="margin-left: 15px;">
                        </div>
    ...
    <script src="${pageContext.request.contextPath }/adminResources/js/ckeditor.js"></script>
    <script src="${pageContext.request.contextPath }/adminResources/js/jquery.js"></script>
    <script src="${pageContext.request.contextPath }/adminResources/js/summernote.min.js"></script>
    <script src="${pageContext.request.contextPath }/adminResources/js/form-validation.min.js"></script>
