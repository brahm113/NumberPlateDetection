                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-external-link-square"></i> Add Offence
                            ...
                            <div class="panel-body">
                                <h2><i class="fa fa-pencil-square teal"></i> Offence</h2>
                               
                                <hr>
                                
                               <%@taglib prefix="sp" uri="http://www.springframework.org/tags/form"%>
                                <sp:form action="insertOffence" method="post" role="form" modelAttribute="offenceData">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="successHandler alert alert-success no-display">
                                                <i class="fa fa-ok"></i> Successfully Submitted your Feedback!
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">
                                                    Offence <span class="symbol required"></span>
                                                </label>
                                                <sp:input placeholder="Insert Offence" class="form-control" id="firstname" path="offenceName"/>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                By clicking ADD, you are agreeing to the Policy and Terms &amp; Conditions.
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <input class="btn btn-yellow btn-block" type="submit" value="Add Offence">
