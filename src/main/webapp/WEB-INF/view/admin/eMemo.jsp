				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							Connection c = DriverManager.getConnection("jdbc:mysql://localhost/projectdatabase","root","root");
							Statement st = c.createStatement();
							ResultSet rs2 = st.executeQuery("SELECT detection.number_plate, detection.offence, owner.owner_name FROM detection INNER JOIN OWNER ON detection.number_plate = owner.number_plate");
