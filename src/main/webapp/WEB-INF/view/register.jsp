...
<body class="login example1">
    ...
    <div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
        ...
        <div class="box-login">
                    ...
                    <f:form id="registration" class="form-inline" action="/insertRegister" modelAttribute="registerdata"
                        method="POST">
                        ...
                        <div class="errorHandler alert alert-danger no-display">
                            ...
                            <div class="form-group">
                                ...
                                <f:input id="firstname" type="text" placeholder="Insert your First Name"
                        ...
                        <div class="form-group">
                            ...
                            <f:input id="lastname" type="text" placeholder="Insert your Last Name" class="form-control"
                                path="lastname" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <label for="signupInputName" class="control-label">Area</label><br>
                ...
                <div class="form-group">
                    ...
                    <f:input id="zipcode" type="text" placeholder="Enter Zip Code" class="form-control"
                        path="zipcode" />
                </div>
                 <p>
                 ...
                 <div class="form-group">
                    ...
                    <f:input id="email" type="email" placeholder="Text Field" class="form-control"
                        path="loginModel.username" />
                </div>
               <div class="form-group">
                    <label class="control-label">
                        Password <span class="symbol required"></span>
                    </label>
                    <f:input id="password" type="password" placeholder="Password" class="form-control lock-input"
                        path="loginModel.password" />
                ...
                <div class="form-group">
                    ...
                    <input id="password" type="password" placeholder="Retype Password" class="form-control lock-input"
                        name="confirmPassword" />

                </div>
            <div class="form-actions">
                    <a href="/" class="btn btn-light-grey go-back">
